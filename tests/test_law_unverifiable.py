...
from cookieradar.cli import _print_law_check
from cookieradar.law_checker import ActStatus, Citation, LawCheckResult
from cookieradar.law_fetcher import GDPR
...
def law(source: str, *, sha256: str | None) -> LawCheckResult:
    return LawCheckResult(
        citations=[Citation(finding="violation", law=GDPR.name, article="32(1)",
