"""
CookieRadar — EU and Italian law text from EUR-Lex and Normattiva.

Downloads the acts CookieRadar reports cite and extracts their articles, down to
...
from cookieradar import __version__
...
USER_AGENT = f"CookieRadar/{__version__} (+https://github.com/maksimtech/cookieradar)"
